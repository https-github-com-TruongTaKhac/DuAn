...
const Cart = (props: Props) => {
  return (
    <div>
      <div className="lg:w-[1170px] mb:w-[342px] lg:mt-8 mb:mt-6 lg:mx-auto mx-2 grid lg:grid-cols-[686px_420px] mb:grid-cols-[100%] justify-between *:w-full pb-10">
        <div>
          <span className="text-xl flex mb-[1px] items-center justify-between pb-6 border-b lg:mt-0 mt-4">
            Your Cart
            <p className="text-[#9D9EA2] lg:text-base mb:text-sm">(3)</p>
          </span>
          {/* list items */}
          <div className="flex flex-col border-b lg:pb-[22px] mb:pb-3">
            <section className="flex lg:mt-[23px] mb:mt-[15px] gap-x-4 mt-4">
              <img
              ...
              <div className="relative w-full flex flex-col *:justify-between gap-y-2.5 lg:gap-y-3">
                <div className="lg:py-2 mb-0.5 lg:mb-0 flex lg:flex-row mb:flex-col lg:items-center gap-x-4 py-4">
                  <span className="text-[#9D9EA2] text-sm">
                    Add Integra Pack - 4g
                  </span>
                  <div className="relative lg:absolute lg:left-1/2 lg:-translate-x-[20.5%]">
                    <div className="lg:mt-0 mb:mt-[12.5px] flex items-center">
                      <div className="flex items-center *:grid *:place-items-center *:lg:w-9 *:lg:h-9 *:w-8 *h-8 justify-between">
                        <button>
                          <svg
                      ...
                      <span className="ml-6 text-sm">$2.00</span>
                    </div>
                    {/* price */}
                    <span className="block absolute lg:hidden text-[#9D9EA2] text-sm top-6 right-0">
                      $2.00
                    </span>
                  </div>
                ...
                {/* subtotal */}
                <div className="w-full flex justify-between text-sm pt-4 lg:pt-4 border-t lg:pb-0 pb-4">
            ...
            <section className="flex items-center border-t lg:pt-6 mb:pt-[17px] lg:mt-[23px] mb:mt-[15px] gap-x-4">
              ...
              />
              <div className="relative w-full flex flex-col *:justify-between gap-y-2.5 lg:gap-y-3">
                <div className="lg:py-2 mb-0.5 lg:mb-0 flex lg:flex-row mb:flex-col lg:items-center gap-x-4 py-8">
                  <span className="text-[#9D9EA2] text-sm">
                    Add Integra Pack - 4g
                  </span>
                  <div className="relative lg:absolute lg:left-1/2 lg:-translate-x-[20.5%]">
        ...
        <div className="hidden lg:block">
          <div className="w-full lg:p-6 mb:p-5 border rounded-2xl flex flex-col gap-y-[3px]">
            ...
            <span className="flex mt-0.5 gap-x-[3px] items-center font-medium text-sm text-[#717378]">
              Get Free
              <p className="text-[#1A1E26]">Shipping</p>
              for orders over
            ...
            <div className="flex flex-col gap-y-4 border-t mt-[3px] pt-[22px]">
              ...
              <div className="flex items-center gap-x-3 *:cursor-pointer">
                <img src="./assets/images/mastercard_v1.png" alt="" />
                <img src="./assets/images/mastercard_v2.png" alt="" />
                <img src="./assets/images/mastercard_v3.png" alt="" />
                <img src="./assets/images/mastercard_v4.png" alt="" />
              </div>
            </div>
          </div>
        </div>
        <div className="w-full flex flex-col gap-y-3.5 lg:-mt-6 mb:mt-12">
          <div className="flex justify-between lg:gap-x-6 *:w-full mt-4">
            <span className="text-[#17AF26]">Delivery</span>
            <span />
            <span className="text-[#17AF26] hidden lg:block">Free Returns</span>
          </div>
          <section className="w-full flex lg:flex-row flex-col lg:justify-between lg:items-start lg:gap-x-6 gap-y-[22px] *:w-full lg:mt-0 mb:mt-0.5">
            <div className="p-4 flex flex-col gap-y-3.5 border rounded-xl">
              <img
                className="w-12 h-12 p-3 rounded-[50%] bg-[#F2F6F4]"
                src="./assets/images/transaction-minus.png"
                alt=""
              />
            ...
            <div className="p-4 flex flex-col lg:gap-y-3.5 mb:gap-y-4 border rounded-xl">
              <img
                className="w-12 h-12 p-3 rounded-[50%] bg-[#F2F6F4]"
                src="./assets/images/box-time.png"
                alt=""
              />
            ...
            <div>
              <span className="text-[#17AF26] lg:hidden block lg:mb-0 mb-4">
                Free Returns
              </span>
              <div className="p-4 flex flex-col gap-y-3.5 border rounded-xl">
                <img
                  className="w-12 h-12 p-3 rounded-[50%] bg-[#F2F6F4]"
                  src="./assets/images/truck-time.png"
                  alt=""
                />
        ...
        <div className="block lg:hidden mt-[35px]">
          <div className="w-full lg:p-6 p-5 border rounded-2xl flex flex-col gap-y-[3px]">
            <div className="flex flex-col gap-y-4">
              <section className="flex justify-between text-sm">
                <span className="text-[#9D9EA2]">Subtotal </span>
                <p>$497.00</p>
