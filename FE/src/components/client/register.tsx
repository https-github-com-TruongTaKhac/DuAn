            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form>
                ...
                <div className="mb-8">
                  <button
                    type="submit"
                    className="flex w-full items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray p-4 font-medium bg-[#505F4E] hover:bg-opacity-70 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-70 text-xl text-white cursor-pointer"
                  >
                    Register
                  </button>
                </div>
