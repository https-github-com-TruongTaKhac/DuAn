...
const Login = (props: Props) => {
  ...
  <div className="my-20">
    <div className="flex flex-wrap items-center">
      <div className="w-1/2 border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2 mx-auto rounded-sm border border-stroke bg-white shadow-default shadow-xl dark:border-strokedark dark:bg-boxdark">
          ...
          <form >
            <div className="mb-4">
              ...
              <div className="relative">
                <input type="email" placeholder="Enter your email" className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
            ...
            <div className="mb-8">
              ...
              <div className="relative">
                <input type="password"  placeholder="Enter your password" className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" />
                <span className="absolute right-4 top-4">
                  <svg className="fill-current" width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g opacity="0.5">
            ...
            <div className="mb-8">
              <button type="submit" className="flex w-full items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray p-4 font-medium bg-[#505F4E] hover:bg-opacity-70 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-70 text-xl text-white cursor-pointer">
                Sign In</button>
              
            </div>
            <button className="flex w-full items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray p-4 font-medium bg-[#505F4E] hover:bg-opacity-70 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-70 text-white cursor-pointer">
              <span>
            ...
            <div className="my-8 text-center">
              <p className="font-medium">
                ...
                <a href="#" className="text-primary text-blue-500"> Register</a>
              </p>
            </div>
          </form>
        </div>
